...
GitHub Actions update checks stay enabled. CI also checks the committed patch
for whitespace errors without rewriting legacy files that predate this fork.
