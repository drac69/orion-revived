...
channel_manager_add_favourite_full_block=$(sed -n '/void ChannelManager::addToFavourites(const quint64 &id, const QString &serviceName/,/^}/p' "$repo_dir/src/model/channelmanager.cpp")
channel_manager_add_favourite_id_block=$(sed -n '/void ChannelManager::addToFavourites(const quint64 &id)/,/^}/p' "$repo_dir/src/model/channelmanager.cpp")
