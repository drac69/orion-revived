...
* CI validates the Android manifest version, package name, lifecycle metadata, required network permissions, absence of `WAKE_LOCK`, and `FLAG_KEEP_SCREEN_ON` source path.
